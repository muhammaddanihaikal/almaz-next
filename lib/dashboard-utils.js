...
export function getSesiPenjualanBreakdown(sesi) {
  ...
  const titipJual = 0 
  // Tukar Barang: Hitung selisih netto (Keluar - Masuk)
  const tukarBarang = sumBy(mergeTukarBarang(sesi), (tukar) => {
...
export function getSesiProfit(sesi, rokokById) {
  ...
  const tukarBarangProfit = sumBy(mergeTukarBarang(sesi), (tukar) => {
